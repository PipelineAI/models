...
def main():
    ...
    dtrain = _get_train_dmatrix()
    dtest = _get_test_dmatrix()
    ...
    _pickle_artifact(model, training_run_datetime)

    _cross_validate_results(params, dtrain)


def _get_train_dmatrix() -> xgb.DMatrix:
    """
...
def _cross_validate_results(params: dict, dtrain: xgb.DMatrix):
    """
...
def _pickle_artifact(model, train_datetime: str) -> str:
    """
