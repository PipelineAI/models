...
# Download and untar the inception model as follows:
...
tf.app.flags.DEFINE_string('checkpoint_dir', './inception-v3',
                           """Directory where to read training checkpoints.""")
tf.app.flags.DEFINE_string('output_dir', './pipeline_tfserving',
                           """Directory where to export inference model.""")
tf.app.flags.DEFINE_integer('model_version', 0,
...
if __name__ == '__main__':
  print("This will take a minute, so please be patient.  If you see an error, make sure you download and untar the inception model.  See README.md.")
  tf.app.run()
